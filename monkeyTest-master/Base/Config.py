...
class Config:
    ...
    # monkey 参数
    monkey_parameters = "--throttle 300 --ignore-crashes --ignore-timeouts --pct-touch 80 --pct-trackball 5 --pct-appswitch 5 --pct-syskeys 5 --pct-motion 5 -v -v 100"
    # log保存地址
    log_location = "H:\\PyCharm\\monkeyTest-master\\log\\"
    #性能数据存储目录
    info_path = "H:\\PyCharm\\monkeyTest-master\\info\\"
